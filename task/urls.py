...
urlpatterns = [
    ...
    path('tasksList/pending',views.PendingTaskList.as_view(), name='task.pendingTasksList'),
    path('tasksList/completed',views.CompletedTaskList.as_view(), name='task.completedTasksList'),
